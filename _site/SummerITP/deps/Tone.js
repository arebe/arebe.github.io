(function (root) {
	...
	Module(function (Tone) {
		 ...
		 *  @param {Tone.Type.NormalRange} [velocity=1] the velocity of the note
	...
	Module(function (Tone) {
		 ...
		 *  
		 *  @param {Tone.Type.Time} [time=now] the time the attack should start
		 *  @param {Tone.Type.NormalRange} [velocity=1] the velocity of the note (0-1)
	...
	Module(function (Tone) {
	    ...
	    Tone.SimpleAM = function (options) {
	        ...
	        this.frequency = new Tone.Signal(440, Tone.Type.Frequency);
	        /**
			 *  The ratio between the carrier and the modulator frequencies. 
			 *  @type {Tone.Multiply}
			 *  @private
			 *  @example
			 * //a harmonicity of 2 sets the modulator an octave above the carrier frequency
	...
	Module(function (Tone) {
		 ...
		 * @name harmonicity
		 */
	    Object.defineProperty(Tone.SimpleFM.prototype, 'harmonicity', {
	        get: function () {
	            return this._harmonicity.value;
	        },
	        set: function (harm) {
